...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: "Inter_600SemiBold", fontSize: 14, color: "#F5F5F5" },
  markAll: { fontFamily: "Inter_400Regular", fontSize: 12, color: "#C49A3C" },
  emptyWrap: { alignItems: "center", gap: 8, paddingVertical: 36 },
  empty: { fontFamily: "Inter_400Regular", fontSize: 12, color: "rgba(255,255,255,0.3)", textAlign: "center", paddingVertical: 20 },
  row: {
  ...
  rowTitle: { fontFamily: "Inter_500Medium", fontSize: 13, color: "#F5F5F5", marginBottom: 2 },
  rowBody: { fontFamily: "Inter_400Regular", fontSize: 12, color: "rgba(255,255,255,0.45)", lineHeight: 17 },
  rowTime: { fontFamily: "Inter_400Regular", fontSize: 10, color: "rgba(255,255,255,0.3)" },
